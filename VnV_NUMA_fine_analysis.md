...
**PS** Рабочие кейсы, включая скрипты прогона полной матрицы эксперимента: V1--V6, будут выложены (добавлены) в этот Репозиторий (от англ. repository — «хранилище»)  позже на конечной стадии, во избежание раздувания объема...
